...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    <li class=""><a href="../indexaing.jsp"><i class="icon icon-home"></i> <span>Dashboard</span></a> </li>
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> 
        ...
        <a href="#" title="" class="tip-bottom"><i class="icon-desktop"></i>Detalle</a>
    </div>
  </div>
<!--End-breadcrumbs-->
              ...
              <div class="span6">
                <table class="">
                  <tbody>
                    ...
                    <tr>
                        <td><img src="<%out.print(request.getParameter("imagen"));%>"</td>
                    </tr>
              ...
              <div class="span6">
                <table class="table table-bordered table-invoice">
                  <tbody>
                    <tr>
                    <tr>
                      <td class="width30"># de Registro:</td>
                      <td class="width70"><strong><% out.print(request.getParameter("id")); %></strong></td>
                    </tr>
                    <tr>
                      <td>Serie:</td>
                      <td><strong><% out.print(request.getParameter("serie")); %></strong></td>
                    </tr>
                    <tr>
                      <td>Marca:</td>
                      <td><strong><% out.print(request.getParameter("fabricante")); %></strong></td>
                    </tr>
                    <tr>
                      <td>Categoria:</td>
                      <td><strong><% out.print(request.getParameter("categoria")); %></strong></td>
                    </tr>
                    <tr>
                      <td>Tipo:</td>
            ...
            <div class="row-fluid">
              <div class="span12">
                ...
                <div class="pull-right">
                  ...
                  <a class="btn btn-warning btn-large pull-right" href="lista.jsp">Regresar</a> 
                </div>
              </div>
            </div>
          </div>
