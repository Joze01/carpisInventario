<%-- 
    Document   : asignarImagen
    Created on : 11-01-2017, 02:45:02 PM
    Author     : Jose-PC
--%>
          ...
          <div class="widget-content nopadding">
             <form class="form-horizontal" method="post" action="/inventariocapris/productoController" enctype = "multipart/form-data" name="basic_validate" id="basic_validate" novalidate="novalidate">
              <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" disabled class="required" name="serie" value="<%out.print(request.getParameter("serie"));%>" id="required">
                </div>
              </div>
               <div class="control-group">
              ...
              <div class="form-actions">
                  <input type="hidden" name="idproducto" value="<%out.print(request.getParameter("id"));%>"/>
                  <input type="hidden" name="metodo" value="asignarImagen"/>
                <input type="submit" value="Asignar Imagen" class="btn btn-success">
              </div>
            </form>
          </div>
        </div>
